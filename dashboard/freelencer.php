...
<?php
//     $sql = "SELECT `nick_name`.`skil`, `user`.`name`,`ID`
//     FROM `freelencer`
        ...
        <div class="w-full p-6">
            <table class="border-collapse border border-gray-300 bg-gray-100" style="width:100%">
                <thead>
                    ...
                    <th class="border-y border-gray-100 bg-gray-50/50 p-2" scope="col">Nickname</th>
                    <th class="border-y border-gray-100 bg-gray-50/50 p-2" scope="col">Skil</th>
